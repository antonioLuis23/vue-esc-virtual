    ...
    <main>
      ...
      <div class="teknisa">
        <div class="navbar">
          <img
            class="logo-teknisa"
            :src="require('@/assets/images/logo-large.color.maida.svg')"
            alt="Teknisa"
          />
            ...
            <form class="search-form">
              <input
                :style="{
                  backgroundImage:
                    'url(' +
                    require('@/assets/icons/search-black-48dp.svg') +
                    ')',
                }"
                type="text"
                class="search-box"
        ...
        <div v-show="isResult" class="search-container">
          <div class="grid-search">
            <InfoFuncionario
              v-for="(funcionario, index) in resultFunc"
              :key="index"
              :teleportPopup="true"
...
export default {
    ...
    return {
      ...
      setores: [
          ...
          subsetores: [
            {
              ...
              infos: [
                {
                  ...
                  texto:
                    "DM ocorre todos os dias às 09:30h na sala https://meet.google.com/rew-woip-sig",
                },
              ],
              // salas: [
              //   {
              ...
              funcionarios: [
                ...
                },
                {
                  ...
                  setor: "Aimores",
                  chat:
                    "https://maidahealth.workplace.com/chat/t/100071494925250",
                  email: "exemplo@maidahealth.com",
                },
                {
                  nome: "Dayvid Emerson",
                  ...
                  setor: "Aimores",
                  chat:
                    "https://maidahealth.workplace.com/chat/t/100071079637357",
                  email: "exemplo@maidahealth.com",
                },
                {
                  nome: "Filipe Mateus",
                  ...
                  setor: "Aimores",
                  chat:
                    "https://maidahealth.workplace.com/chat/t/100070725758156",
                  email: "exemplo@maidahealth.com",
                },
              ],
            },
        ...
        },
        {
          ...
          info: [
            {
              titulo: "Aniversário Maida",
              texto:
                "No nosso aniversário, nossos líderes Ney e Gustavo farão um pocket super despojado respondendo perguntas sobre eles e sobre a empresa. É muito importante a participação de todos nesse momento mais que especial. #LetsGoFurther Confirme sua presença, e nos vemos no meet: https://bit.ly/AniversárioMaida",
            },
          ],
        },
      ],
  ...
  computed: {
    listaFunc() {
      ...
      let listaSubsetores = this.setores.flatMap((setor) =>
        setor.subsetores ? setor.subsetores : []
      );
      //retorna a lista de todos os funcionarios dentro de subsetores;
      return listaSubsetores.flatMap((subsetor) =>
        subsetor.funcionarios ? subsetor.funcionarios : []
      );
    },
  },
  methods: {
    submitSearch: function() {
      if (this.searchQuery === "") {
        ...
        this.resultFunc = this.listaFunc.filter((func) =>
          func.nome.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
